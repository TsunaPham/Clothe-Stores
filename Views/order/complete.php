...
<div class="page section-header text-center">
    <div class="page-title">
        <div class="wrapper">
            <h1 class="page-width">Thanks You Buyed Product from HCMUT Clothe Store</h1>
        </div>
    </div>
</div>
<!--End Page Title-->
                ...
                <fieldset>
                    <div class="row">
                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                            ...
                            <input name="DiaChi" value="<?php echo $_SESSION['DiaChiDien']  ?>" id="input-address-1" type="text" readonly="readonly">
                        </div>
                </fieldset>
            </div>
        </div>
